...
const secondStepWords = ["Тепло", "Любовь", "Радость"]; // Массив слов для второго шага
...
const quizQuestions = [ // Массив вопросов для третьего шага
  ...
  {
    question: "Нить какого цвета соединяет связанные судьбы",
    options: ["Зеленая", "Оранжевая", "Синяя", "Красная"],
    correctAnswer: "Красная"
  },
  {
    question: "Какой город в Европе ты очень любишь и хочешь туда поехать?",
    options: ["Париж", "Париж", "Париж", "Париж"],
    correctAnswer: "Париж"
  }
];

const valentinText = "Эта валентинка для моей любимой!" // Текст для финального шага
